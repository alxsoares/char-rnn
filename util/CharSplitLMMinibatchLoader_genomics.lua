...
function CharSplitLMMinibatchLoader.create(data_dir, batch_size, seq_length, split_fractions)
    ...
    -- count vocab
    self.vocab_size = 0
    for _,i in pairs(self.vocab_mapping) do
        print("ho",_,i) 
    ...
    --Hmm...so in our cases the last character
    --won't have anything to do with anything...I need to make sure that in the train code
    --there is no prediction for the last character...
